...
import com.fatec.PI3Semestre.service.TurmaService;
...
public class TurmaController {
    ...
    /**
     * Método para deletar uma turma e suas reservas
     * @param codTurma do tipo Integer
     * @return ResponseEntity<Void>
     */
    @DeleteMapping("/{codTurma}")
    public ResponseEntity<Void> deleteTurmaAndReservas(@PathVariable Integer codTurma) {
